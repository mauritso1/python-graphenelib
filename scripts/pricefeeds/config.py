...
_all_assets = ["BTC", "SILVER", "GOLD", "TRY", "SGD", "HKD", "NZD",
               ...
               "KRW", "TCNY", "TUSD", "ALTCAP", "ALTCAP.X" ]  # "SHENZHEN", "HANGSENG", "NASDAQC", "NIKKEI", "RUB", "SEK"
...
################################################################################
feedSources = {}
feedSources["coinmarketcap"] = feedsources.Coinmarketcap(quotes=["ALTCAP", "ALTCAP.X"], quoteName={"ALTCAP":"ALTCAP", "ALTCAP.X":"ALTCAP.X"], bases=["BTS"]}
